# GroomProfileSection Specification

## Overview
- **Target file:** `src/components/reveused/GroomProfileSection.tsx`
- **Screenshot:** `docs/design-references/reveused-mobile-03-profile.png`
...
- lineHeight: 24px
- color: rgb(51, 51, 51)
- backgroundImage: url("https://groovepublic.com/wp-content/uploads/2024/03/reveused-imam-nandira-00188.jpg.jpeg")
- background: rgba(0, 0, 0, 0) url("https://groovepublic.com/wp-content/uploads/2024/03/reveused-imam-nandira-00188.jpg.jpeg") repeat scroll 50% 50% / cover padding-box border-box
...
### Text Nodes / Headings
- "THE GROOM" — "Times New Roman", sans-serif, 12px, 400, 17px
- "Imam Faizan" — Candlefish, sans-serif, 36px, 500, 36px
- "The second son of" — Thesignature, sans-serif, 35px, 300, 17px
- "Imam" — Legan, sans-serif, 13px, 500, 13px
...
## Assets
- Background image: `public/images/reveused/reveused-imam-nandira-00188.jpg.jpeg`
- Section screenshot: `docs/design-references/reveused-mobile-03-profile.png`

## Text Content (verbatim)
THE GROOM Imam Faizan The second son of Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo. Imam
