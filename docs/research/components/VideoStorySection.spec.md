# VideoStorySection Specification

## Overview
- **Target file:** `src/components/reveused/VideoStorySection.tsx`
- **Screenshot:** `docs/design-references/reveused-mobile-14-7a254bb2.png`
...
### Text Nodes / Headings
- "UNVEILING OUR PREWEDDING STORY" — Candlefish, sans-serif, 21px, 400, 21px
...
- Stateful details: click-driven video play placeholder.
...
- Section screenshot: `docs/design-references/reveused-mobile-14-7a254bb2.png`

## Text Content (verbatim)
UNVEILING OUR PREWEDDING STORY Play Video Every love story is beautiful, but ours is my favorite. Through the highs and lows, our love grows stronger and deeper with each passing day.
